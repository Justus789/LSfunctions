...
```
The last function is files(). This function is made for others like me, who get confused why a command doesn't find a directory. This function can show the current working directory and the folder structure around it. This way you can find or see the path your command should follow to find the directory.
